    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="classifieds-category">
		  ...
		  @endif -->
			  <a href="{{URL::to($cat->category_slug.'/'.$subcat->sub_category_slug.'/'.$subcat->id)}}">{{$subcat->sub_category_name}} <span>({{ \App\SubCategories::countSubCategoryListings($subcat->id) }})</span></a></li>
              @endforeach
