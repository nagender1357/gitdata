                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                {!! Form::open(array('url' => array('admin/subcategories/addsubcategory'),'class'=>'form-horizontal padding-15','name'=>'category_form','id'=>'category_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="file" name="sub_category_image" id="input-file" class="form-control input-md">  @if(isset($subcat->sub_category_image))
											<img src="{{ URL::asset('upload/sub_category_image/'.$subcat->sub_category_image.'-s.jpg') }}" width="80" alt="category">
									@endif
										</div>
									</div>
                                    <hr>
