                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                             ...
                             <!--    <li><a class="{{classActivePath('subcategories')}}" href="{{ URL::to('admin/subcategories') }}"><i class="fa fa-list-ul"></i>Sub Categories</a></li> -->
								<li><a class="{{classActivePath('country')}}" href="{{ URL::to('admin/country') }}"><i class="fa fa-globe"></i>Countries</a></li>
								<li><a class="{{classActivePath('region')}}" href="{{ URL::to('admin/region') }}"><i class="fa fa-location-arrow"></i>Region</a></li>
                                 <li><a class="{{classActivePath('locations')}}" href="{{ URL::to('admin/locations') }}"><i class="fa fa-location-arrow"></i>City</a></li>
