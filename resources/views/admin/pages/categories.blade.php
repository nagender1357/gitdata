                        ...
                        <div class="block-content">
                            ...
                            <table class="table table-bordered table-striped cat-dataTable-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="font-w600">{{ $category->category_name }}</td>
										 <td class="font-w600">{{ \App\Categories::getSub($category->parent_id) }}</td>
                                        <td class="font-w600">{{ $category->category_slug }}</td>
										 <td class="font-w600">@if(isset($category->status) && $category->status==1) Active @endif
										 @if(isset($category->status) && $category->status==0) Inactive @endif
										 </td>
