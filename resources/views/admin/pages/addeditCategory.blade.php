                            ...
                            <span aria-hidden="true">&times;</span></button>
                               ...
                               <!--   <div class="form-group">
                                        ...
                                        <label for="" class="col-sm-3 control-label">Category</label>
                                          ...
                                          <div class="col-sm-9">
                                            ...
                                            <select id="basic2" name="category_id" class="js-select2 form-control">
												...
												<?php  if($add==1){?>
												 <option value="0" @if(is_null($cat->parent_id)) selected @endif>--Top Category--{{$cat->parent_id}}</option>
				                ...
				                <option  value="{{$category->id}}"  @if(isset($cat->parent_id) && $cat->parent_id==$category->id) selected="selected" @endif  >
									...
									@endforeach
									<?php  } else {?> 
									<option value="0" selected>--Top Category--</option>
                                     @foreach($categories as $category)
									<option  value="{{$category->id}}"  selected="selected" >{{ $category->category_name }}</option>
				                   @include('admin.pages.addmanageChild',['childs' => $category->childs,'a'=>1])
								   @endforeach
									<?php }?>
									</select>
                                        </div>
