                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">                            
                            <a class="pull-right btn btn-primary push-5-r push-10" href="{{URL::to('admin/locations/addlocation')}}"><i class="fa fa-plus"></i> Add City</a>
                        </div>
                        <div class="block-content">
                            ...
                            <table class="table table-bordered table-striped cat-dataTable-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										 <td class="font-w600">{{ \App\Country::getCountryName($location->parent_id) }}</td>
                                        <td class="font-w600">{{ $location->location_name }}</td>
                                        <td class="font-w600">{{ $location->location_slug }}</td>
										 <td class="font-w600">@if(isset($location->status) && $location->status==1) Active @endif
										 @if(isset($location->status) && $location->status==0) Inactive @endif
										 </td>
