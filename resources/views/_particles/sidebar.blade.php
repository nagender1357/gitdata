...
<script src="{{ URL::asset('site_assets/js/jquery.min.js') }}"></script>
@elseif(Route::getCurrentRoute()->getActionName() == 'App\Http\Controllers\ListingsUserController@listings')
<script src="{{ URL::asset('site_assets/js/jquery.min.js') }}"></script>
@endif
          ...
          {!! Form::open(array('url' => 'listings/search/filter','class'=>'','id'=>'search','role'=>'form')) !!}
            <div class="col-md-12 form-group">
              ...
              <select id="cate_search" name="cate_search" class="form-control">
                ...
                @foreach(\App\Categories::where('status',1)->whereNull('parent_id')->orderBy('category_name')->get() as $category)
