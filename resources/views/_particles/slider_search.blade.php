    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-1 col-md-10 finder-block">
          ...
          <div class="">
          <select id="country_location" name="country_location" class="form-control">
            <option value="">Select Country</option>
            @foreach(\App\Country::where(array('status'=>'1'))->orderBy('country_name')->get() as $country_location) 
            <option value="{{$country_location->id}}">{{$country_location->country_name}}</option> 
            @endforeach
