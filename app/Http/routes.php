...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	Route::post('testing_policy', 'SettingsController@testing_policy');
	...
	Route::get('country/addcountry', 'CountryController@addeditCountry'); 
	Route::get('country/addcountry/{id}', 'CountryController@editCountry');	
	Route::post('country/addcountry', 'CountryController@addnew');	
	Route::get('country/delete/{id}', 'CountryController@delete');
	
	Route::get('region', 'RegionController@region');	
	Route::get('region/addregion', 'RegionController@addeditRegion'); 
	Route::get('region/addregion/{id}', 'RegionController@editRegion');	
	Route::post('region/addregion', 'RegionController@addnew');	
	Route::get('region/delete/{id}', 'RegionController@delete');

	Route::get('ajax_country/{id}', 'LocationController@ajax_country');
...
Route::get('testingpolicy', 'IndexController@testingpolicy');
//Social Login
...
Route::post('password/emailapi', 'Auth\PasswordController@postapiEmail');
...
Route::get('ajax_region/{id}', 'ListingsUserController@ajax_region');
Route::get('ajax_subcatedata/{id}', 'ListingsUserController@ajax_subcatedata');
Route::get('ajax_sub_subcatedata/{id}', 'ListingsUserController@ajax_sub_subcatedata');
//Route::get('ajax_country/{id}', 'LocationController@ajax_country');
...
Route::get('{category_slug}/{sub_category_slug}/{sub_sub_category_slug}/{sub_sub_cat_id}', 'SubCategoriesController@subsubcate');
