...
class CategoriesController extends MainAdminController
{
    ...
    public function addeditCategory()    { 
        ...
        if(Auth::User()->usertype!="Admin"){
            ...
            return redirect('admin/dashboard');
				  ...
				  // echo"<pre>";print_r($categories);echo"</pre>"; echo"sdf";die();
				  $allCategories = Categories::pluck('category_name','id')->all();
                  return view('admin.pages.addeditCategory',compact('categories','allCategories'));
    }
    ...
    { 
		...
		$cat->parent_id = $inputs['category_id'];
  ...
  public static function getSub($id) 
    ...
    {     
        ...
        $allCategories = Categories::pluck('category_name','id')->all();
		return view('admin.pages.addeditCategory',compact('cat','categories','allCategories'));
